...
puts cmd="valac ext/src/rubyplugin.vala --pkg gtk+-3.0 --pkg libxfce4panel-2.0 -o librubyplugin.so --shared-library rubyplugin --library rubyplugin -X -fPIC -X -shared -X ext/src/rbld.c -X #{rbflgs}"
system cmd
EOR
